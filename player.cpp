...
player_data new_player()
{
    ...
    int spritewidth = sprite_width(result.player_sprite);
    int spriteheight = sprite_height(result.player_sprite);
    int screen_center_x = (screen_width() - spritewidth) / 2;
    int screen_center_y = (screen_height() - spriteheight) / 2;

    // Position in the centre of the initial screen
    sprite_set_x(result.player_sprite, screen_center_x);
    sprite_set_y(result.player_sprite, screen_center_y);
